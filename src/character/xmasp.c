...
//Christimas Parents character assets
static u8 char_xmasp_arc_main[] = {
	#include "iso/xmasp/main.arc.h"
};
...
static Character *Char_XmasP_New(fixed_t x, fixed_t y)
{
	...
	this->character.health_b = 0xFFf55fa4;
	...
	for (; *pathp != NULL; pathp++)
		*arc_ptr++ = Archive_Find((IO_Data)char_xmasp_arc_main, *pathp);
